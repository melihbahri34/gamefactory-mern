...
function App() {
	...
	return (
		<div class="pt-16">
          <div class="w-full max-w-sm p-6 m-auto bg-white rounded-md shadow-md dark:bg-gray-800 pt-6">
            <h1 class="text-3xl font-semibold text-center text-gray-700 dark:text-white">Welcome back!</h1>
            <form class="mt-6" onSubmit={loginUser}>
                <div>
            ...
            <p class="mt-8 text-xs font-light text-center text-gray-400"> Don't have an account? <a href={ROUTES.REGISTER}
